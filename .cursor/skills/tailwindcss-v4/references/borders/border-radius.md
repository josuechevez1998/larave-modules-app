...
- Consulta esta referencia cuando necesites trabajar con **border-radius**.
...
```html
<div class="rounded rounded-lg rounded-full"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `border-radius`, por ejemplo una clase completa con `[...]`.
