...
- Consulta esta referencia cuando necesites trabajar con **outline-offset**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `outline-offset`, por ejemplo una clase completa con `[...]`.
