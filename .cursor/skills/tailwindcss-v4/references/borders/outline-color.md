...
- Consulta esta referencia cuando necesites trabajar con **outline-color**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `outline-color`, por ejemplo una clase completa con `[...]`.
