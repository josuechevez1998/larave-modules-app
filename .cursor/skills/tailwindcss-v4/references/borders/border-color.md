...
Controla bordes, radios y outlines.

## Uso en el proyecto

- Consulta esta referencia cuando necesites trabajar con **border-color**.
...
```html
<div class="border-slate-200 border-primary/50"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `border-color`, por ejemplo una clase completa con `[...]`.
