...
- Consulta esta referencia cuando necesites trabajar con **border-style**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `border-style`, por ejemplo una clase completa con `[...]`.
