...
- Consulta esta referencia cuando necesites trabajar con **outline-width**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `outline-width`, por ejemplo una clase completa con `[...]`.
