...
- Consulta esta referencia cuando necesites trabajar con **caption-side**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `caption-side`, por ejemplo una clase completa con `[...]`.
