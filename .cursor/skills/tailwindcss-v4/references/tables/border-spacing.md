...
- Consulta esta referencia cuando necesites trabajar con **border-spacing**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `border-spacing`, por ejemplo una clase completa con `[...]`.
