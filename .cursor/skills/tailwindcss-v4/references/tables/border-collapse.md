...
Controla presentación y distribución de tablas.

## Uso en el proyecto

- Consulta esta referencia cuando necesites trabajar con **border-collapse**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `border-collapse`, por ejemplo una clase completa con `[...]`.
