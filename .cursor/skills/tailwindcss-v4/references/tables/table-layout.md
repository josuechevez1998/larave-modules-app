...
- Consulta esta referencia cuando necesites trabajar con **table-layout**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `table-layout`, por ejemplo una clase completa con `[...]`.
