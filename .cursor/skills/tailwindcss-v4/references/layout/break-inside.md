...
- Consulta esta referencia cuando necesites trabajar con **break-inside**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `break-inside`, por ejemplo una clase completa con `[...]`.
