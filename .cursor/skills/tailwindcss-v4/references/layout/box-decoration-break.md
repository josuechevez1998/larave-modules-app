...
- Consulta esta referencia cuando necesites trabajar con **box-decoration-break**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `box-decoration-break`, por ejemplo una clase completa con `[...]`.
