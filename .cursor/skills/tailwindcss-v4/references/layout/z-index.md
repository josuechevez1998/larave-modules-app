...
- Consulta esta referencia cuando necesites trabajar con **z-index**.
...
```html
<div class="z-0 z-10 z-50 z-[100]"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `z-index`, por ejemplo una clase completa con `[...]`.
