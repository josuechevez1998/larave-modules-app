...
- Consulta esta referencia cuando necesites trabajar con **aspect-ratio**.
...
```html
<div class="aspect-square aspect-video aspect-[4/3]"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `aspect-ratio`, por ejemplo una clase completa con `[...]`.
