...
- Consulta esta referencia cuando necesites trabajar con **object-position**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `object-position`, por ejemplo una clase completa con `[...]`.
