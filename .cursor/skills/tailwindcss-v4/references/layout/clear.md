...
- Consulta esta referencia cuando necesites trabajar con **clear**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `clear`, por ejemplo una clase completa con `[...]`.
