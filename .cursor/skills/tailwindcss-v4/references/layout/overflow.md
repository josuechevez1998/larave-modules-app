...
- Consulta esta referencia cuando necesites trabajar con **overflow**.
...
```html
<div class="overflow-auto overflow-hidden overflow-x-scroll"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `overflow`, por ejemplo una clase completa con `[...]`.
