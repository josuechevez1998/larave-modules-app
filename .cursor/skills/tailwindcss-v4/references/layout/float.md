...
- Consulta esta referencia cuando necesites trabajar con **float**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `float`, por ejemplo una clase completa con `[...]`.
