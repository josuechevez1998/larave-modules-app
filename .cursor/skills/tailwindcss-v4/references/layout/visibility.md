...
- Consulta esta referencia cuando necesites trabajar con **visibility**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `visibility`, por ejemplo una clase completa con `[...]`.
