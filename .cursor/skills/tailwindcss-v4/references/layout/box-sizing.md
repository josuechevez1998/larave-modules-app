...
- Consulta esta referencia cuando necesites trabajar con **box-sizing**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `box-sizing`, por ejemplo una clase completa con `[...]`.
