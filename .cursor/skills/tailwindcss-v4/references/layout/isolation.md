...
- Consulta esta referencia cuando necesites trabajar con **isolation**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `isolation`, por ejemplo una clase completa con `[...]`.
