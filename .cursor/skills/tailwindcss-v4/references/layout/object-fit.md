...
- Consulta esta referencia cuando necesites trabajar con **object-fit**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `object-fit`, por ejemplo una clase completa con `[...]`.
