...
- Consulta esta referencia cuando necesites trabajar con **break-after**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `break-after`, por ejemplo una clase completa con `[...]`.
