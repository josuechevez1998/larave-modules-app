...
- Consulta esta referencia cuando necesites trabajar con **break-before**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `break-before`, por ejemplo una clase completa con `[...]`.
