...
- Consulta esta referencia cuando necesites trabajar con **text-shadow**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `text-shadow`, por ejemplo una clase completa con `[...]`.
