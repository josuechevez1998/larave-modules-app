...
- Consulta esta referencia cuando necesites trabajar con **background-blend-mode**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `background-blend-mode`, por ejemplo una clase completa con `[...]`.
