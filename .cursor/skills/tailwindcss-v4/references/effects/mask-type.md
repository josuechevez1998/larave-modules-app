...
- Consulta esta referencia cuando necesites trabajar con **mask-type**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `mask-type`, por ejemplo una clase completa con `[...]`.
