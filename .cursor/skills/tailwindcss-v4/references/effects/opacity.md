...
- Consulta esta referencia cuando necesites trabajar con **opacity**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `opacity`, por ejemplo una clase completa con `[...]`.
