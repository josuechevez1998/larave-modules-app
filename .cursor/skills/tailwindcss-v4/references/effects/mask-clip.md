...
- Consulta esta referencia cuando necesites trabajar con **mask-clip**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `mask-clip`, por ejemplo una clase completa con `[...]`.
