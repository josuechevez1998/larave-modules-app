...
- Consulta esta referencia cuando necesites trabajar con **mask-repeat**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `mask-repeat`, por ejemplo una clase completa con `[...]`.
