...
- Consulta esta referencia cuando necesites trabajar con **mask-position**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `mask-position`, por ejemplo una clase completa con `[...]`.
