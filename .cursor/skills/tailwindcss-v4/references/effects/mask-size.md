...
- Consulta esta referencia cuando necesites trabajar con **mask-size**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `mask-size`, por ejemplo una clase completa con `[...]`.
