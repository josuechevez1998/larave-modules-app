...
- Consulta esta referencia cuando necesites trabajar con **mask-mode**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `mask-mode`, por ejemplo una clase completa con `[...]`.
