...
- Consulta esta referencia cuando necesites trabajar con **mask-image**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `mask-image`, por ejemplo una clase completa con `[...]`.
