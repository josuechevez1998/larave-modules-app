...
- Consulta esta referencia cuando necesites trabajar con **mask-composite**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `mask-composite`, por ejemplo una clase completa con `[...]`.
