...
Controla transformaciones 2D/3D y perspectiva.

## Uso en el proyecto

- Consulta esta referencia cuando necesites trabajar con **scale**.
...
```html
<div class="scale-95 scale-100 hover:scale-105"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `scale`, por ejemplo una clase completa con `[...]`.
