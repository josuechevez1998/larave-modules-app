...
- Consulta esta referencia cuando necesites trabajar con **perspective-origin**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `perspective-origin`, por ejemplo una clase completa con `[...]`.
