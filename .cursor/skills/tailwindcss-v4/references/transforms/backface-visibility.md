...
- Consulta esta referencia cuando necesites trabajar con **backface-visibility**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `backface-visibility`, por ejemplo una clase completa con `[...]`.
