...
- Consulta esta referencia cuando necesites trabajar con **zoom**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `zoom`, por ejemplo una clase completa con `[...]`.
