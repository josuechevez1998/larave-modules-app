...
- Consulta esta referencia cuando necesites trabajar con **transform-origin**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `transform-origin`, por ejemplo una clase completa con `[...]`.
