...
- Consulta esta referencia cuando necesites trabajar con **perspective**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `perspective`, por ejemplo una clase completa con `[...]`.
