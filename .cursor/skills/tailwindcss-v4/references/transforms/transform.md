...
- Consulta esta referencia cuando necesites trabajar con **transform**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `transform`, por ejemplo una clase completa con `[...]`.
