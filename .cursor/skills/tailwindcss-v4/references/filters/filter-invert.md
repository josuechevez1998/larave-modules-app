...
- Consulta esta referencia cuando necesites trabajar con **invert**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `filter-invert`, por ejemplo una clase completa con `[...]`.
