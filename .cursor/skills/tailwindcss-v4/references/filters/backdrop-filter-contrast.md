...
- Consulta esta referencia cuando necesites trabajar con **backdrop contrast**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `backdrop-filter-contrast`, por ejemplo una clase completa con `[...]`.
