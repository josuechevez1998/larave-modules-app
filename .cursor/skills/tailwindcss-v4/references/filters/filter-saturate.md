...
- Consulta esta referencia cuando necesites trabajar con **saturate**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `filter-saturate`, por ejemplo una clase completa con `[...]`.
