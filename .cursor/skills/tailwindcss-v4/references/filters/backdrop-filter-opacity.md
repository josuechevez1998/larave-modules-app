...
- Consulta esta referencia cuando necesites trabajar con **backdrop opacity**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `backdrop-filter-opacity`, por ejemplo una clase completa con `[...]`.
