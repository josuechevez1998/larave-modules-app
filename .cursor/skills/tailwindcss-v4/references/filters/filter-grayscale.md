...
- Consulta esta referencia cuando necesites trabajar con **grayscale**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `filter-grayscale`, por ejemplo una clase completa con `[...]`.
