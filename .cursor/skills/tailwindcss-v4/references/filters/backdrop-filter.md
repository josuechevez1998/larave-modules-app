...
- Consulta esta referencia cuando necesites trabajar con **backdrop-filter**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `backdrop-filter`, por ejemplo una clase completa con `[...]`.
