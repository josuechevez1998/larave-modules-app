...
- Consulta esta referencia cuando necesites trabajar con **blur**.
...
```html
<div class="blur-none blur-sm blur-xl"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `filter-blur`, por ejemplo una clase completa con `[...]`.
