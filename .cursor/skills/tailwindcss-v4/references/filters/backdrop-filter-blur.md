...
- Consulta esta referencia cuando necesites trabajar con **backdrop blur**.
...
```html
<div class="backdrop-blur-sm backdrop-blur-xl"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `backdrop-filter-blur`, por ejemplo una clase completa con `[...]`.
