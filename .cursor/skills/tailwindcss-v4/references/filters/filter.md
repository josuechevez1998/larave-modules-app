...
- Consulta esta referencia cuando necesites trabajar con **filter**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `filter`, por ejemplo una clase completa con `[...]`.
