...
- Consulta esta referencia cuando necesites trabajar con **drop-shadow**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `filter-drop-shadow`, por ejemplo una clase completa con `[...]`.
