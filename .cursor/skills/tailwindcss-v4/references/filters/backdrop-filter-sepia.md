...
- Consulta esta referencia cuando necesites trabajar con **backdrop sepia**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `backdrop-filter-sepia`, por ejemplo una clase completa con `[...]`.
