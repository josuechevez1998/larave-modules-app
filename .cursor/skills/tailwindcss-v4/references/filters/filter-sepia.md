...
- Consulta esta referencia cuando necesites trabajar con **sepia**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `filter-sepia`, por ejemplo una clase completa con `[...]`.
