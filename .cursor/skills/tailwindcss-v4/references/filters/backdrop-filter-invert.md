...
- Consulta esta referencia cuando necesites trabajar con **backdrop invert**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `backdrop-filter-invert`, por ejemplo una clase completa con `[...]`.
