...
- Consulta esta referencia cuando necesites trabajar con **backdrop saturate**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `backdrop-filter-saturate`, por ejemplo una clase completa con `[...]`.
