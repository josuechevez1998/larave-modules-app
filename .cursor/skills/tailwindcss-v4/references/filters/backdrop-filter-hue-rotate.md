...
- Consulta esta referencia cuando necesites trabajar con **backdrop hue-rotate**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `backdrop-filter-hue-rotate`, por ejemplo una clase completa con `[...]`.
