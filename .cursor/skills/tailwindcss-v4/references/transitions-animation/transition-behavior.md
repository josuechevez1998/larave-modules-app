...
- Consulta esta referencia cuando necesites trabajar con **transition-behavior**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `transition-behavior`, por ejemplo una clase completa con `[...]`.
