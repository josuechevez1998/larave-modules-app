...
- Consulta esta referencia cuando necesites trabajar con **animation**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `animation`, por ejemplo una clase completa con `[...]`.
