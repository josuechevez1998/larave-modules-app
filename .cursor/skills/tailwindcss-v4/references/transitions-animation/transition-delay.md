...
- Consulta esta referencia cuando necesites trabajar con **transition-delay**.
...
```html
<div class="delay-75 delay-300"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `transition-delay`, por ejemplo una clase completa con `[...]`.
