...
- Consulta esta referencia cuando necesites trabajar con **transition-timing-function**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `transition-timing-function`, por ejemplo una clase completa con `[...]`.
