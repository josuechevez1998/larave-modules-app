...
Controla relleno y trazo de SVG.

## Uso en el proyecto

- Consulta esta referencia cuando necesites trabajar con **stroke-width**.
...
```html
<div class="stroke-1 stroke-2"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `stroke-width`, por ejemplo una clase completa con `[...]`.
