...
- Consulta esta referencia cuando necesites trabajar con **block-size**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `block-size`, por ejemplo una clase completa con `[...]`.
