...
- Consulta esta referencia cuando necesites trabajar con **inline-size**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `inline-size`, por ejemplo una clase completa con `[...]`.
