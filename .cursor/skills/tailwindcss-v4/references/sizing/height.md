...
- Consulta esta referencia cuando necesites trabajar con **height**.
...
```html
<div class="h-full h-screen h-12"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `height`, por ejemplo una clase completa con `[...]`.
