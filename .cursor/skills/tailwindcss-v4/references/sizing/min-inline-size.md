...
- Consulta esta referencia cuando necesites trabajar con **min-inline-size**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `min-inline-size`, por ejemplo una clase completa con `[...]`.
