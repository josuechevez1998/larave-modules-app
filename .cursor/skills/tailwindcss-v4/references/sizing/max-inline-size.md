...
- Consulta esta referencia cuando necesites trabajar con **max-inline-size**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `max-inline-size`, por ejemplo una clase completa con `[...]`.
