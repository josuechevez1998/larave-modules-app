...
- Consulta esta referencia cuando necesites trabajar con **min-width**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `min-width`, por ejemplo una clase completa con `[...]`.
