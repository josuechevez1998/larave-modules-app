...
- Consulta esta referencia cuando necesites trabajar con **max-block-size**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `max-block-size`, por ejemplo una clase completa con `[...]`.
