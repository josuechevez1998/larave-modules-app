...
- Consulta esta referencia cuando necesites trabajar con **min-block-size**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `min-block-size`, por ejemplo una clase completa con `[...]`.
