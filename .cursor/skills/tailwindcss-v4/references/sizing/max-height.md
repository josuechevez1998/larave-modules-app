...
- Consulta esta referencia cuando necesites trabajar con **max-height**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `max-height`, por ejemplo una clase completa con `[...]`.
