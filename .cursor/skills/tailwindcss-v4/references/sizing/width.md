...
- Consulta esta referencia cuando necesites trabajar con **width**.
...
```html
<div class="w-full w-1/2 w-64 w-[42rem]"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `width`, por ejemplo una clase completa con `[...]`.
