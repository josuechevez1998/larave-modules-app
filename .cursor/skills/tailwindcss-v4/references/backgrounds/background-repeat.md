...
- Consulta esta referencia cuando necesites trabajar con **background-repeat**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `background-repeat`, por ejemplo una clase completa con `[...]`.
