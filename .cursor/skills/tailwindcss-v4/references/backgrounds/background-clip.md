...
- Consulta esta referencia cuando necesites trabajar con **background-clip**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `background-clip`, por ejemplo una clase completa con `[...]`.
