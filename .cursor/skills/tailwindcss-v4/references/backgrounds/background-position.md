...
- Consulta esta referencia cuando necesites trabajar con **background-position**.
...
```html
<div class="bg-center bg-top bg-[position:25%_75%]"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `background-position`, por ejemplo una clase completa con `[...]`.
