...
- Consulta esta referencia cuando necesites trabajar con **text-wrap**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `text-wrap`, por ejemplo una clase completa con `[...]`.
