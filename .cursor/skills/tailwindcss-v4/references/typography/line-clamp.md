...
- Consulta esta referencia cuando necesites trabajar con **line-clamp**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `line-clamp`, por ejemplo una clase completa con `[...]`.
