...
- Consulta esta referencia cuando necesites trabajar con **font-family**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `font-family`, por ejemplo una clase completa con `[...]`.
