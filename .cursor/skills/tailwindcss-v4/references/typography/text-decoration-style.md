...
- Consulta esta referencia cuando necesites trabajar con **text-decoration-style**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `text-decoration-style`, por ejemplo una clase completa con `[...]`.
