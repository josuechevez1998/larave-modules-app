...
- Consulta esta referencia cuando necesites trabajar con **text-transform**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `text-transform`, por ejemplo una clase completa con `[...]`.
