...
- Consulta esta referencia cuando necesites trabajar con **text-decoration-line**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `text-decoration-line`, por ejemplo una clase completa con `[...]`.
