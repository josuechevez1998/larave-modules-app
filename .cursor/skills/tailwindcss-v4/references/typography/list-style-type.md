...
- Consulta esta referencia cuando necesites trabajar con **list-style-type**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `list-style-type`, por ejemplo una clase completa con `[...]`.
