...
- Consulta esta referencia cuando necesites trabajar con **font-smoothing**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `font-smoothing`, por ejemplo una clase completa con `[...]`.
