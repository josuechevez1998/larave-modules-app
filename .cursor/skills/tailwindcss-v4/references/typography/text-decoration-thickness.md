...
- Consulta esta referencia cuando necesites trabajar con **text-decoration-thickness**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `text-decoration-thickness`, por ejemplo una clase completa con `[...]`.
