...
- Consulta esta referencia cuando necesites trabajar con **font-stretch**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `font-stretch`, por ejemplo una clase completa con `[...]`.
