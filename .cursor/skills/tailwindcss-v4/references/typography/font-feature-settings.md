...
- Consulta esta referencia cuando necesites trabajar con **font-feature-settings**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `font-feature-settings`, por ejemplo una clase completa con `[...]`.
