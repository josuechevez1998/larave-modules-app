...
- Consulta esta referencia cuando necesites trabajar con **font-style**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `font-style`, por ejemplo una clase completa con `[...]`.
