...
- Consulta esta referencia cuando necesites trabajar con **font-size**.
...
```html
<div class="text-sm text-base text-2xl"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `font-size`, por ejemplo una clase completa con `[...]`.
