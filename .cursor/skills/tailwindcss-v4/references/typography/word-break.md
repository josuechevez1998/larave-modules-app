...
- Consulta esta referencia cuando necesites trabajar con **word-break**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `word-break`, por ejemplo una clase completa con `[...]`.
