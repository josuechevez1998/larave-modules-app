...
Controla fuente, texto, listas, espacios y composición tipográfica.

## Uso en el proyecto

- Consulta esta referencia cuando necesites trabajar con **line-height**.
...
```html
<div class="leading-none leading-normal leading-7"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `line-height`, por ejemplo una clase completa con `[...]`.
