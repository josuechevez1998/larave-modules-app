...
- Consulta esta referencia cuando necesites trabajar con **overflow-wrap**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `overflow-wrap`, por ejemplo una clase completa con `[...]`.
