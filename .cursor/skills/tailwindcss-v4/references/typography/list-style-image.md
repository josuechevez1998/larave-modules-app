...
- Consulta esta referencia cuando necesites trabajar con **list-style-image**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `list-style-image`, por ejemplo una clase completa con `[...]`.
