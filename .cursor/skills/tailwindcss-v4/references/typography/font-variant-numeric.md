...
- Consulta esta referencia cuando necesites trabajar con **font-variant-numeric**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `font-variant-numeric`, por ejemplo una clase completa con `[...]`.
