...
- Consulta esta referencia cuando necesites trabajar con **white-space**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `white-space`, por ejemplo una clase completa con `[...]`.
