...
- Consulta esta referencia cuando necesites trabajar con **color**.
...
```html
<div class="text-slate-900 text-white/80 text-primary"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `color`, por ejemplo una clase completa con `[...]`.
