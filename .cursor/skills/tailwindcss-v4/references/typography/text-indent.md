...
- Consulta esta referencia cuando necesites trabajar con **text-indent**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `text-indent`, por ejemplo una clase completa con `[...]`.
