...
- Consulta esta referencia cuando necesites trabajar con **text-align**.
...
```html
<div class="text-left text-center text-right"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `text-align`, por ejemplo una clase completa con `[...]`.
