...
- Consulta esta referencia cuando necesites trabajar con **list-style-position**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `list-style-position`, por ejemplo una clase completa con `[...]`.
