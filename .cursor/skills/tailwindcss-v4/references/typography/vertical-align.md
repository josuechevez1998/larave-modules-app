...
- Consulta esta referencia cuando necesites trabajar con **vertical-align**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `vertical-align`, por ejemplo una clase completa con `[...]`.
