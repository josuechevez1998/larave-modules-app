...
- Consulta esta referencia cuando necesites trabajar con **tab-size**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `tab-size`, por ejemplo una clase completa con `[...]`.
