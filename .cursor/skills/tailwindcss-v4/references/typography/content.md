...
- Consulta esta referencia cuando necesites trabajar con **content**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `content`, por ejemplo una clase completa con `[...]`.
