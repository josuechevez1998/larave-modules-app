...
- Consulta esta referencia cuando necesites trabajar con **hyphens**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `hyphens`, por ejemplo una clase completa con `[...]`.
