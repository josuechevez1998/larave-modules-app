...
- Consulta esta referencia cuando necesites trabajar con **scrollbar-width**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `scrollbar-width`, por ejemplo una clase completa con `[...]`.
