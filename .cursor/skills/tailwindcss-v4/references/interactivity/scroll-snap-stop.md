...
- Consulta esta referencia cuando necesites trabajar con **scroll-snap-stop**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `scroll-snap-stop`, por ejemplo una clase completa con `[...]`.
