...
- Consulta esta referencia cuando necesites trabajar con **scroll-snap-type**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `scroll-snap-type`, por ejemplo una clase completa con `[...]`.
