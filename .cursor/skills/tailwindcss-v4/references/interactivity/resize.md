...
- Consulta esta referencia cuando necesites trabajar con **resize**.
...
```html
<div class="resize resize-x resize-none"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `resize`, por ejemplo una clase completa con `[...]`.
