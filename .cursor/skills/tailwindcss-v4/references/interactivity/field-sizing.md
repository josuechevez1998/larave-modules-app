...
- Consulta esta referencia cuando necesites trabajar con **field-sizing**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `field-sizing`, por ejemplo una clase completa con `[...]`.
