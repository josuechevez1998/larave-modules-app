...
- Consulta esta referencia cuando necesites trabajar con **will-change**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `will-change`, por ejemplo una clase completa con `[...]`.
