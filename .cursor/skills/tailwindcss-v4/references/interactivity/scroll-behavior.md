...
- Consulta esta referencia cuando necesites trabajar con **scroll-behavior**.
...
```html
<div class="scroll-auto scroll-smooth"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `scroll-behavior`, por ejemplo una clase completa con `[...]`.
