...
- Consulta esta referencia cuando necesites trabajar con **appearance**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `appearance`, por ejemplo una clase completa con `[...]`.
