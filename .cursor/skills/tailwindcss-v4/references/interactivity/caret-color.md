...
- Consulta esta referencia cuando necesites trabajar con **caret-color**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `caret-color`, por ejemplo una clase completa con `[...]`.
