...
- Consulta esta referencia cuando necesites trabajar con **scrollbar-color**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `scrollbar-color`, por ejemplo una clase completa con `[...]`.
