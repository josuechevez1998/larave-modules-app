...
- Consulta esta referencia cuando necesites trabajar con **scroll-snap-align**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `scroll-snap-align`, por ejemplo una clase completa con `[...]`.
