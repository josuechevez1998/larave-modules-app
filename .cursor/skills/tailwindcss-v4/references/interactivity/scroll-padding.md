...
- Consulta esta referencia cuando necesites trabajar con **scroll-padding**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `scroll-padding`, por ejemplo una clase completa con `[...]`.
