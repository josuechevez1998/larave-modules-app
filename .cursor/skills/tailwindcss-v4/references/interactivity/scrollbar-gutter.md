...
- Consulta esta referencia cuando necesites trabajar con **scrollbar-gutter**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `scrollbar-gutter`, por ejemplo una clase completa con `[...]`.
