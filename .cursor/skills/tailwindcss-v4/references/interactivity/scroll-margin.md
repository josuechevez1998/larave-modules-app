...
- Consulta esta referencia cuando necesites trabajar con **scroll-margin**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `scroll-margin`, por ejemplo una clase completa con `[...]`.
