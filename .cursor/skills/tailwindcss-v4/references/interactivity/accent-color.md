...
- Consulta esta referencia cuando necesites trabajar con **accent-color**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `accent-color`, por ejemplo una clase completa con `[...]`.
