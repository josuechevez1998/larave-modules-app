...
- Consulta esta referencia cuando necesites trabajar con **touch-action**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `touch-action`, por ejemplo una clase completa con `[...]`.
