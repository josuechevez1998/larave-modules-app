...
- Consulta esta referencia cuando necesites trabajar con **grid-column**.
...
```html
<div class="col-span-2 col-start-2 col-end-4"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `grid-column`, por ejemplo una clase completa con `[...]`.
