...
- Consulta esta referencia cuando necesites trabajar con **grid-row**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `grid-row`, por ejemplo una clase completa con `[...]`.
