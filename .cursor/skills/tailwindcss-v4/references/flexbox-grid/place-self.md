...
- Consulta esta referencia cuando necesites trabajar con **place-self**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `place-self`, por ejemplo una clase completa con `[...]`.
