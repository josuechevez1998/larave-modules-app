...
- Consulta esta referencia cuando necesites trabajar con **grid-template-columns**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `grid-template-columns`, por ejemplo una clase completa con `[...]`.
