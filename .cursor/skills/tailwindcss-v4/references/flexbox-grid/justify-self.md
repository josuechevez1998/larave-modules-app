...
- Consulta esta referencia cuando necesites trabajar con **justify-self**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `justify-self`, por ejemplo una clase completa con `[...]`.
