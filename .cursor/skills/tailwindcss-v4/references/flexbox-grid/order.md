...
- Consulta esta referencia cuando necesites trabajar con **order**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `order`, por ejemplo una clase completa con `[...]`.
