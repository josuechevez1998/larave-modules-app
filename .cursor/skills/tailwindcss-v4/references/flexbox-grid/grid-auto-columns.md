...
- Consulta esta referencia cuando necesites trabajar con **grid-auto-columns**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `grid-auto-columns`, por ejemplo una clase completa con `[...]`.
