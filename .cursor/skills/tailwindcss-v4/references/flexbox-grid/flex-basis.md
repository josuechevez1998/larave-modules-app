...
- Consulta esta referencia cuando necesites trabajar con **flex-basis**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `flex-basis`, por ejemplo una clase completa con `[...]`.
