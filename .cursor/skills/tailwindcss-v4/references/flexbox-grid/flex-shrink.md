...
- Consulta esta referencia cuando necesites trabajar con **flex-shrink**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `flex-shrink`, por ejemplo una clase completa con `[...]`.
