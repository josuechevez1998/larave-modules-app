...
- Consulta esta referencia cuando necesites trabajar con **flex**.
...
```html
<div class="flex-1 flex-auto flex-none"></div>
```

## Valores arbitrarios

Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `flex`, por ejemplo una clase completa con `[...]`.
