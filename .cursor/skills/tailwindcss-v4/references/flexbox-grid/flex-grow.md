...
- Consulta esta referencia cuando necesites trabajar con **flex-grow**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `flex-grow`, por ejemplo una clase completa con `[...]`.
