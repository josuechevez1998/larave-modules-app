...
- Consulta esta referencia cuando necesites trabajar con **align-self**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `align-self`, por ejemplo una clase completa con `[...]`.
