...
- Consulta esta referencia cuando necesites trabajar con **grid-auto-rows**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `grid-auto-rows`, por ejemplo una clase completa con `[...]`.
