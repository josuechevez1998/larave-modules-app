...
- Consulta esta referencia cuando necesites trabajar con **justify-items**.
...
Cuando la escala no cubra el caso, utiliza la sintaxis arbitraria documentada para `justify-items`, por ejemplo una clase completa con `[...]`.
