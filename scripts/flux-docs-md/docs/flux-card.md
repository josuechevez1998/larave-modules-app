...
> Fuente: https://fluxui.dev/components/card
...
Create hierarchical section headings for content](/components/heading)
[Text

Format paragraphs and textual content with consistent styling](/components/text)
