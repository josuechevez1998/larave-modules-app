...
> Fuente: https://fluxui.dev/components/navbar
...
Organize content into separate panels](/components/tabs)
[Header

Top navigation headers for your application](/layouts/header)
[Sidebar

Primary or secondary navigation sidebars](/layouts/sidebar)
