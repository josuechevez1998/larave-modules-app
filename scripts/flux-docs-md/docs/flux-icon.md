...
> Fuente: https://fluxui.dev/components/icon
...
Interactive controls with integrated icons](/components/button)
[Input

Text fields with leading or trailing icons](/components/input)
[Badge

Small indicators with optional icon content](/components/badge)
