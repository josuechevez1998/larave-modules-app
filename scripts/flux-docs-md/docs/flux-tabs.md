...
> Fuente: https://fluxui.dev/components/tabs
...
Build responsive navigation bars](/components/navbar)
[Radio

Allow users to select a single option from a list](/components/radio)
