...
> Fuente: https://fluxui.dev/components/timeline
...
1. ​
   ...
   curtisss requested a review from james\_rob · 4 days ago
2. ​
...
3. ​
   ...
   james\_rob approved these changes · 3 days ago
...
2. james\_rob
   ...
   replied to your message · 4 days ago
...
1. ​
   ...
   curtisss requested a review from james\_rob · 4 days ago
2. ![](https://github.com/joshhanley.png)

   james\_rob commented · 4 days ago

   Contrast slider goes a bit wild at the top end...

   ![](https://github.com/calebporzio.png)
...
1. ​
   ...
   Align indicator and content to the top/start
2. ​
   ...
   Align indicator and content to the baseline of the first line of text
3. ​
   ...
   Align indicator and content to the center
4. ​
   ...
   Align indicator and content to the bottom/end

```
<flux:timeline align="start|baseline|center|end">    <!-- ... --></flux:timeline>
```

### [Baseline adjustment](#baseline-adjustment)
...
1. ​
   ...
   The indicator may not align perfectly with large text
2. ​
   ...
   The indicator aligns precisely with the heading baseline
...
Display progress toward a goal or completion](/components/progress)
[Tabs

Organize content into switchable panels](/components/tabs)

## Reference

### [flux:timeline](#fluxtimeline)
...
### [flux:timeline.item](#fluxtimelineitem)
...
### [flux:timeline.indicator](#fluxtimelineindicator)
...
### [flux:timeline.content](#fluxtimelinecontent)
...
### [flux:timeline.block](#fluxtimelineblock)
...
### [flux:timeline.subgrid](#fluxtimelinesubgrid)
