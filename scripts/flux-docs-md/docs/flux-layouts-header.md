...
> Fuente: https://fluxui.dev/layouts/header
...
Create primary or secondary navigation sidebars](/layouts/sidebar)
[Brand

Display your company logo and name consistently](/components/brand)
[Navbar

Build responsive navigation bars with dropdown menus](/components/navbar)
[Profile
