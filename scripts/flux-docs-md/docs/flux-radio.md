...
> Fuente: https://fluxui.dev/components/radio
...
Toggleable input control for making multiple selections](/components/checkbox)
[Select

Dropdown selection menus for choosing from options](/components/select)
