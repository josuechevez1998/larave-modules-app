...
> Fuente: https://fluxui.dev/components/callout
...
Display temporary notifications with a toast](/components/toast)
[Card

Display content in a card component](/components/card)
