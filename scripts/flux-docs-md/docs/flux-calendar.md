...
> Fuente: https://fluxui.dev/components/calendar
...
```
<flux:calendar value="2026-07-10" />
```
...
```
<flux:calendar    multiple    value="2026-07-02,2026-07-05,2026-07-15"/>
```
...
```
<flux:calendar    static    value="2026-07-10"    size="xs"    :navigation="false"/>
```
...
```
<flux:calendar unavailable="2026-07-09,2026-07-11" />
```
