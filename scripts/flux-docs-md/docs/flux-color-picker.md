...
> Fuente: https://fluxui.dev/components/color-picker
...
## [Custom swatches](#custom-swatches)
...
### [flux:color-picker](#fluxcolor-picker)

| Prop | Description |
| --- | --- |
| wire:model | Binds the color picker to a Livewire property. The value is a CSS color string in the configured format. See the [wire:model documentation](https://livewire.laravel.com/docs/wire-model) for more information. |
...
### [flux:color-picker.dropper](#fluxcolor-pickerdropper)
