...
> Fuente: https://tenancyforlaravel.com/docs/v3/early-identification
...
- <https://github.com/stancl/tenancy/blob/2.x/src/Middleware/InitializeTenancy.php>
- <https://github.com/stancl/tenancy/blob/2.x/src/Middleware/PreventAccessFromTenantDomains.php>
