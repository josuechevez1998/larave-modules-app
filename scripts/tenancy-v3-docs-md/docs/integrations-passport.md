...
> Fuente: https://tenancyforlaravel.com/docs/v3/integrations/passport
...
To achieve that, enable the [Tenant Config](https://tenancyforlaravel.com/docs/v3/features/tenant-config) feature, and configure the storage-to-config mapping in the `boot` method of your `TenancyServiceProvider` this way:
