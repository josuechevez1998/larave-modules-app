...
> Fuente: https://tenancyforlaravel.com/docs/v3/single-database-tenancy
...
You can still use the other [tenancy bootstrappers](https://tenancyforlaravel.com/docs/v3/tenancy-bootstrappers) to separate tenant caches, filesystems, etc.
...
If that feels like a chore, you may use the `Stancl\Tenancy\Database\Concerns\HasScopedValidationRules` trait on your custom [Tenant](https://tenancyforlaravel.com/docs/v3/tenants) model to add methods for these two rules.
