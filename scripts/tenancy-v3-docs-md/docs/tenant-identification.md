...
> Fuente: https://tenancyforlaravel.com/docs/v3/tenant-identification
...
Be sure to read the [Domains](https://tenancyforlaravel.com/docs/v3/domains) page of the documentation.
...
See the [manual initialization page](https://tenancyforlaravel.com/docs/v3/manual-initialization) to see how to identify tenants manually.

## Customizing onFail logic

Each identification middleware has a [static `$onFail` property](https://tenancyforlaravel.com/docs/v3/configuration/#static-properties) that can be used to customize the behavior that should happen when a tenant couldn't be identified.
