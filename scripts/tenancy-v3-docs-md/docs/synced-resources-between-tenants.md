...
> Fuente: https://tenancyforlaravel.com/docs/v3/synced-resources-between-tenants
...
Also note that if you create a user in the tenant's database, the global id will be created using the ID generator. If you disable the ID generator for [incrementing tenant ids](https://tenancyforlaravel.com/docs/v3/tenants#incrementing-ids), you'll need to make some changes.
