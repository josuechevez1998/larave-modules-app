...
> Fuente: https://tenancyforlaravel.com/docs/v3/integrations/spatie
...
After that, add your [tenant identification](https://tenancyforlaravel.com/docs/v3/tenant-identification) middlewares to the config file's `middleware` key:
