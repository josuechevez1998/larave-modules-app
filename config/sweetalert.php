...
return [
    ...
    */
    ...
    'background' => env('SWEET_ALERT_BACKGROUND', 'var(--color-app-surface, #faf9f7)'),
    ...
    */
    ...
    'customClass' => [
        ...
        'container' => env('SWEET_ALERT_CONTAINER_CLASS', 'swal-app'),
        'popup' => env('SWEET_ALERT_POPUP_CLASS', 'swal-app-popup'),
        'header' => env('SWEET_ALERT_HEADER_CLASS'),
        'title' => env('SWEET_ALERT_TITLE_CLASS', 'swal-app-title'),
        'closeButton' => env('SWEET_ALERT_CLOSE_BUTTON_CLASS'),
        'icon' => env('SWEET_ALERT_ICON_CLASS'),
        'image' => env('SWEET_ALERT_IMAGE_CLASS'),
        'content' => env('SWEET_ALERT_CONTENT_CLASS', 'swal-app-content'),
        'input' => env('SWEET_ALERT_INPUT_CLASS', 'swal-app-input'),
        'actions' => env('SWEET_ALERT_ACTIONS_CLASS', 'swal-app-actions'),
        'confirmButton' => env('SWEET_ALERT_CONFIRM_BUTTON_CLASS', 'swal-app-confirm'),
        'cancelButton' => env('SWEET_ALERT_CANCEL_BUTTON_CLASS', 'swal-app-cancel'),
    ...
    */
    ...
    'confirm_delete_confirm_button_text' => env('SWEET_ALERT_CONFIRM_DELETE_CONFIRM_BUTTON_TEXT', 'Sí, eliminar'),
    'confirm_delete_confirm_button_color' => env('SWEET_ALERT_CONFIRM_DELETE_CONFIRM_BUTTON_COLOR', '#991b1b'),
    'confirm_delete_cancel_button_color' => env('SWEET_ALERT_CONFIRM_DELETE_CANCEL_BUTTON_COLOR', '#78716c'),
